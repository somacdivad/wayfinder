# Plan-to-PR research index

Research date: 2026-09-15. These briefs record source-grounded findings and the adaptations chosen for this repository. They are advisory resources, not accepted evidence, mutable candidate status, or owner authority. Sources were inspected through their original publisher/author or official documentation pages; each brief identifies the inspected scope and limits.

| Decision area | Brief |
| --- | --- |
| Semi-structured, neutral, concrete-example interviews | [Interviews and elicitation](interviews-and-elicitation.md) |
